...
menu_file = tkinter.Menu(menubar, tearoff = 1)		# 절취선
menu_edit = tkinter.Menu(menubar, tearoff = 1)
menu_help = tkinter.Menu(menubar, tearoff = 1)

menubar.add_cascade(menu = menu_file, label = "File")
menubar.add_cascade(menu = menu_edit, label = "Edit")
menubar.add_cascade(menu = menu_help, label = "Help")

menu_file.add_command(label = "open", command = openfile)	# 써브
menu_file.add_command(label = "save as", command = savefile)
menu_file.add_command(label = "Exit", command = exit)

menu_edit.add_command(label = "open", command = openfile)	# 써브
menu_edit.add_command(label = "save as", command = savefile)
menu_edit.add_command(label = "Exit", command = exit)
